...
The 2001–2020 population denominator is traced to the 2013 revision of the IBGE national population projection. The original acquisition route for the monthly case counts remains unverified. No specific public-source URL or agency acquisition route for the case series is presented as verified provenance. Subject to author confirmation of the access arrangement, the canonical observational file and a reproducible repository bundle or private repository access can be supplied to editors and reviewers during peer review.
