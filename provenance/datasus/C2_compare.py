"""Compare the fixed C2 TabNet output with the canonical monthly cases series."""
...
RAW = AUDIT / "raw" / "C2_datasus_tb_brazil_2001_2022.csv"
...
EXPECTED_RAW_SHA256 = "feb11a85b14074937c70e233197311e84ae4e059f3aff18f0597a60dba3b0aad"
...
def tabnet_months():
    if sha256(RAW) != EXPECTED_RAW_SHA256:
        raise ValueError("C2 captured output SHA-256 differs from the access log")
...
def main():
    ...
    write_csv(AUDIT / "C2_monthly_comparison.csv", comparison)
    write_csv(AUDIT / "C2_discrepant_months.csv", mismatches)
